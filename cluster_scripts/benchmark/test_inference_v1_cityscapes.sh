...
config_path="./configs/bisenetv1/bisenetv1_resnet18_os8_cityscapes_1024x512_160k.yml"
pretrained_path="./pretrained_model/bisenetv1/model.pdparams"
...
export_path="./inference_model/bisenetv1"
