...
config_path="./configs/bisenet/bisenet_voc12aug_512x512_80k.yml"
pretrained_path="./pretrained_model/v2_voc/model.pdparams"
...
export_path="./inference_model/bisenetv2_voc"
