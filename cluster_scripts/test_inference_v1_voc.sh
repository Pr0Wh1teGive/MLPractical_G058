...
config_path="./configs/bisenetv1/bisenetv1_voc12aug_512x512_80k.yml"
pretrained_path="./pretrained_model/v1_voc/model.pdparams"
...
export_path="./inference_model/bisenetv1_voc"
