...
config_path="./configs/stdcseg/stdc2_seg_cityscapes_1024x512_80k.yml"
pretrained_path="./pretrained_model/stdc_cityscapes/model.pdparams"
...
export_path="./inference_model/stdc_cityscapes"
