...
export OUTPUT_DIR=${SCRATCH_HOME}/result/stdc2/cityscapes100_1024x512
mkdir -p ${OUTPUT_DIR}
...
python train.py \
       --config configs/stdcseg/stdc2_seg_cityscapes_1024x512_80k.yml \
       --do_eval \
       --use_vdl \
       --save_interval 10000 \
       --save_dir ${OUTPUT_DIR}
...
OUTPUT_HOME=${PWD}/output/stdc/cityscapes100_1024x512
mkdir -p ${OUTPUT_HOME}
