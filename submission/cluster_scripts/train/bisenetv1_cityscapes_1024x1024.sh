...
export OUTPUT_DIR=${SCRATCH_HOME}/result/bisenetv1/cityscapes100_1024x1024
mkdir -p ${OUTPUT_DIR}
...
python train.py \
       --config configs/bisenetv1/bisenetv1_resnet18_os8_cityscapes_1024x1024_160k.yml \
       --do_eval \
       --use_vdl \
       --save_interval 10000 \
       --save_dir ${OUTPUT_DIR}
...
OUTPUT_HOME=${PWD}/output/bisenetv1/cityscapes100_1024x1024
mkdir -p ${OUTPUT_HOME}
